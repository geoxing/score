...
def get_etf_000905_year_close():
    ...
    # 渲染图表到 HTML 文件
    output_html_file="etf_000905_year_close.html"
    line.render(output_html_file)
    # 使用 snapshot-selenium 将 HTML 文件转换为图片
    output_image_file = "etf_000905_year_close.png"
    output_image(output_html_file,output_image_file)

    send_email_with_image("etf_中证500_year_close","5908386@qq.com","5908386@qq.com","hakgazlgljxrbjbf","etf_000905_year_close.png","etf_中证500_year_close")
