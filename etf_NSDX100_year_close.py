from tools import output_image, send_email_with_image, get_etf_year_close_line_overseas

def get_etf_NSDX100_year_close():
    etf_info_map = {
    ...
    line= get_etf_year_close_line_overseas(etf_info_map)
    # 渲染图表到 HTML 文件
    output_html_file="etf_NSDX100_year_close.html"
    line.render(output_html_file)
    # 使用 snapshot-selenium 将 HTML 文件转换为图片
    output_image_file = "etf_NSDX100_year_close.png"
    output_image(output_html_file,output_image_file)

    send_email_with_image("etf_NSDX100_year_close","5908386@qq.com","5908386@qq.com","hakgazlgljxrbjbf","etf_NSDX100_year_close.png","etf_NSDX100_year_close")
