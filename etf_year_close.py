...
def get_etf_year_close():
    ...
    output_image_file = "etf_year_close.png"
    output_image(output_html_file,output_image_file)

    send_email_with_image("etf_year_close","5908386@qq.com","5908386@qq.com","hakgazlgljxrbjbf","etf_year_close.png","etf_year_close")
